...
class ProjectTagRepository {
  ...
  Future<void> addProject(Project project) async {
    ...
    if (userId == null) {
      throw Exception(AppStrings.noPermissionToAddProject);
    }
    ...
    if (existingProjects.any((p) => p.name.toLowerCase() == projectToAdd.name.toLowerCase())) {
      throw Exception(AppStrings.projectNameExists);
    }
  ...
  Future<void> updateProject(Project updatedProjectData) async {
    final userId = _currentUserId;
    if (userId == null) throw Exception(AppStrings.userNotLoggedIn);
    if (updatedProjectData.id.isEmpty) throw Exception(AppStrings.projectIdCannotBeEmpty);

    final existingProject = projectBox.get(updatedProjectData.id);
    if (existingProject == null || existingProject.userId != userId) {
      throw Exception(AppStrings.projectNotExistOrNoPermissionToEdit);
    }
  ...
  Future<void> archiveProjectByKey(String projectKey) async {
    ...
    if (project != null && project.userId == userId) {
      ...
      throw Exception(AppStrings.projectNotExistOrNoPermissionToArchive);
    }
  }
  ...
  Future<void> restoreProjectByKey(String projectKey) async {
    ...
    if (project != null && project.userId == userId) {
      ...
      throw Exception(AppStrings.projectNotExistOrNoPermissionToRestore);
    }
  }
  ...
  Future<void> addTag(Tag tag) async {
    final userId = _currentUserId;
    if (userId == null) {
      throw Exception(AppStrings.noPermissionToAddTag);
    }
    ...
    if (existingTags.any((t) => t.name.toLowerCase() == tagToAdd.name.toLowerCase())) {
      throw Exception(AppStrings.tagNameExists);
    }
  ...
  Future<void> updateTag(Tag updatedTagData) async {
    final userId = _currentUserId;
    if (userId == null) throw Exception(AppStrings.userNotLoggedIn);
    if (updatedTagData.id.isEmpty) throw Exception(AppStrings.tagIdCannotBeEmpty);

    final existingTag = tagBox.get(updatedTagData.id);
    if (existingTag == null || existingTag.userId != userId) {
      throw Exception(AppStrings.tagNotExistOrNoPermissionToEdit);
    }
  ...
  Future<void> archiveTagByKey(String tagKey) async {
    ...
    if (tag != null && tag.userId == userId) {
      ...
      throw Exception(AppStrings.tagNotExistOrNoPermissionToArchive);
    }
  }
  ...
  Future<void> restoreTagByKey(String tagKey) async {
    ...
    if (tag != null && tag.userId == userId) {
      ...
      throw Exception(AppStrings.tagNotExistOrNoPermissionToRestore);
    }
  }
